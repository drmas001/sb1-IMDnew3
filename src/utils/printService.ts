  ...
  const content = `
    <div style="font-family: Arial, sans-serif; max-width: 800px; margin: 0 auto; padding: 20px;">
      <div style="text-align: center; margin-bottom: 30px;">
        ...
        <p style="color: #6b7280; margin: 5px 0;">${format(new Date(), 'PPpp')}</p>
      </div>
            ...
            <div style="margin-bottom: ${index < patient.admissions!.length - 1 ? '20px' : '0'}; padding-bottom: ${index < patient.admissions!.length - 1 ? '20px' : '0'}; ${index < patient.admissions!.length - 1 ? 'border-bottom: 1px solid #e5e7eb;' : ''}">
              ...
              <table style="width: 100%; border-collapse: collapse;">
                <tr>
                  ...
                  <td style="padding: 4px 0; color: #1f2937;">${format(new Date(admission.admission_date), 'PPP')}</td>
                </tr>
                ${admission.discharge_date ? `
                  <tr>
                    <td style="padding: 4px 0; color: #6b7280;">Discharge Date:</td>
                    <td style="padding: 4px 0; color: #1f2937;">${format(new Date(admission.discharge_date), 'PPP')}</td>
                  </tr>
                ` : ''}
                <tr>
